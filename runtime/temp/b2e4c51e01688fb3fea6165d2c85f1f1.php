<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"E:\www\tp\public/../application/home/view/default/index\list.html";i:1526367425;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container-fluid">
    ...
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="<?php echo url('article/index?category='.$category[3]); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('article/index?category='.$category[4]); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('article/index?category='.$category[5]); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('article/index?category='.$category[6]); ?>">
