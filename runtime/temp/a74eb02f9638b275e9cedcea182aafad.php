<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\www\tp\public/../application/admin/view/default/auth_manager\category.html";i:1496373782;s:67:"E:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="tab-wrap">
	    ...
	    <li class="fr">
		    <select name="group">
			    <?php if(is_array($auth_group) || $auth_group instanceof \think\Collection || $auth_group instanceof \think\Paginator): $i = 0; $__LIST__ = $auth_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				    <option value="<?php echo url('AuthManager/category',array('group_id'=>$vo['id'],'group_name'=>$vo['title'])); ?>" <?php if($vo['id'] == $this_group['id']): ?>selected<?php endif; ?> ><?php echo $vo['title']; ?></option>
			    <?php endforeach; endif; else: echo "" ;endif; ?>
		    </select>
	    </li>
    </ul>
    ...
    <div class="tb-unit posr">
        <form class="save-category" action="<?php echo url('AuthManager/addToCategory'); ?>" method="post" enctype="application/x-www-form-urlencoded">
            ...
            <div class="category auth-category">
                ...
                <?php echo action('AuthManager/tree', array($group_list)); ?>
            </div>

            <div class="tb-unit-bar">
                <button class="btn submit-btn ajax-posts" type="submit" target-form="save-category">确 定</button>
