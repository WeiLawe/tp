<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"E:\www\tp\public/../application/admin/view/default/auth_manager\managergroup.html";i:1496373782;s:67:"E:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="tab-wrap">
        <ul class="tab-nav nav">
            ...
            <li><a href="<?php echo url('AuthManager/user',array('group_name'=>input('group_name') ,'group_id'=> input('group_id'))); ?>">成员授权</a></li>
            <li class="fr">
                <select name="group">
                    <?php if(is_array($auth_group) || $auth_group instanceof \think\Collection || $auth_group instanceof \think\Paginator): $i = 0; $__LIST__ = $auth_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>" {eq  name="vo['id']" value="$this_group['id']">selected{/eq} ><?php echo $vo['title']; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </li>
        </ul>
                                       ...
                                       <?php if(!(empty($child['operator']) || (($child['operator'] instanceof \think\Collection || $child['operator'] instanceof \think\Paginator ) && $child['operator']->isEmpty()))): ?>
                                           ...
                                           <span class="child_row">
                                               <?php if(is_array($child['operator']) || $child['operator'] instanceof \think\Collection || $child['operator'] instanceof \think\Paginator): $i = 0; $__LIST__ = $child['operator'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$op): $mod = ($i % 2 );++$i;?>
                                                   <label class="checkbox" <?php if(!(empty($op['tip']) || (($op['tip'] instanceof \think\Collection || $op['tip'] instanceof \think\Paginator ) && $op['tip']->isEmpty()))): ?>title='<?php echo $op['tip']; ?>'<?php endif; ?>>
...
<script type="text/javascript" src="__PUBLIC__/static/qtip/jquery.qtip.min.js"></script>
<link rel="stylesheet" type="text/css" href="__PUBLIC__/static/qtip/jquery.qtip.min.css" media="all">
