<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"E:\www\tp\public/../application/admin/view/default/repair\edit.html";i:1526201139;s:67:"E:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
<div class="main-title"><h1 style="color: red"><?php echo !empty($info['id'])?'编辑':'新增'; ?>报修</h1></div>
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item cf" style="">
        <label class="item-label">内容</label>
        <div class="controls" style="">
            <textarea name="content" id="" cols="100" rows="10"><?php echo $info['content']; ?></textarea>
        </div>
    </div>
    <div class="form-item">
