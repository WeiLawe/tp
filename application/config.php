...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'eo3b%.wE[Y&Ll?pn}Hk:{f90US*GvTIhW"]a)|tx', //默认数据加密KEY
	'data_cache_key'=> 'eo3b%.wE[Y&Ll?pn}Hk:{f90US*GvTIhW"]a)|tx',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'eo3b%.wE[Y&Ll?pn}Hk:{f90US*GvTIhW"]a)|tx', //加密KEY
